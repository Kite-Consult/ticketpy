...
class AttractionQuery(BaseQuery):
    ...
    def find(
        ...
        **kwargs
        ...
        """
        return self._get(
            keyword, attraction_id, sort, include_test, page, size, locale, source=source, **kwargs
        )
...
class EventQuery(BaseQuery):
    ...
    def by_location(
        self, latitude, longitude, radius="10", unit="miles", sort="relevance,desc", **kwargs
    ):
        ...
        return self.find(latlong=latlong, radius=radius, unit=unit, sort=sort, **kwargs)
