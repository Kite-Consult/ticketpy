...
class TestApiClient(TestCase):
    ...
    def test_parse_link(self):
        ...
        param_str = "sort=date,asc" "&marketId=10" "&keyword=LCD%20Soundsystem"
    ...
    def test__bad_request(self):
        ...
        self.assertRaises(
            ApiException,
            self.api_client.events.by_location,
            latitude=lat,
            longitude=long,
            radius=radius,
        )
...
class TestVenueQuery(TestCase):
    def setUp(self):
        self.tm = get_client()
        self.venues = {"smithes": "KovZpZAJledA", "tabernacle": "KovZpaFEZe"}
...
class TestEventQuery(TestCase):
    ...
    def test_events_get(self):
        ...
        elist = self.tm.events.find(classification_name=genre_name, venue_id=venue_id).limit(2)
